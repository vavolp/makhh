...
send(msg.chat_id,msg.id,"» مرحبا عزيزي في مصنع الحمايه المجاني لسورس مالوركا \n» .","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
----
if text == 'مطور السورس' or text == 'مبرمج السورس' or text == 'بباابب' then  
local UserId_Info = LuaTele.searchPublicChat("X_ErOs")
...
local TestText = "Mallorca\n— — — — — — — — —\n ˖*َdev name»* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n˖*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'MaKer BoTs Protection', url = "https://t.me/GzaBot"}
},
}
...
{
{text = 'ِّّSource Mallorca', url = 't.me/QQQiiQ'}, 
},
}
